...
/*function setMaxValueLabel(a) {
	...
	//alert("myAge: " + inputAge);
    $("#maxValueGraph").html(b1);
	
	computeY4/=2;
	var computeY3=computeY4;
	computeY4 = formatNumber(computeY4, 0);
	var c = "$ " + computeY4;
    $("#maxValueGraph2").html(c);
	
	computeY3/=2;
	var computeY2=computeY3;
	computeY3 = formatNumber(computeY3, 0);
	var d = "$ " + computeY3;
    $("#maxValueGraph3").html(d);
	
	computeY2/=2;
	var computeY1=computeY2;
	computeY2 = formatNumber(computeY2, 0);
	var e = "$ " + computeY2;
    $("#maxValueGraph4").html(e);
	
	computeY1/=2;
	var computeY0=computeY1;
	computeY1 = formatNumber(computeY1, 0);
	var f = "$ " + computeY1;
    $("#maxValueGraph5").html(f);
}*/
...
function setMaxValueLabel(a) {
	...
	//var outputVal = getMaxValue/5;
	//outputVal = formatNumber(outputVal, 0);
	//alert(outputVal);
	
	/*var value4 = outputVal * 4;
	value4 = formatNumber(value4, 0);
	var b2 = "$ " + value4;
	$("#maxValueGraph2").html(b2);
	
	var value3 = outputVal * 3;
	value3 = formatNumber(value3, 0);
	var b3 = "$ " + value3;
	$("#maxValueGraph3").html(b3);
	
	var value2 = outputVal * 2;
	value2 = formatNumber(value2, 0);
	var b4 = "$ " + value2;
	$("#maxValueGraph4").html(b4);
	
	var value1 = outputVal * 1;
	value1 = formatNumber(value1, 0);
	var b5 = "$ " + value1;
	$("#maxValueGraph5").html(b5);*/
